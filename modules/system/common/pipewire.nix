  ...
  services = {
    ...
    in {
      ...
      wireplumber = {
        ...
        configPackages = lib.mkIf lowLatency [
      ...
      # https://gitlab.freedesktop.org/pipewire/pipewire/-/wikis/Config-PipeWire#quantum-ranges
      extraConfig.pipewire."92-low-latency" = lib.mkIf lowLatency {
        "context.properties" = {
      ...
      extraConfig.pipewire-pulse."92-low-latency" = lib.mkIf lowLatency {
        "pulse.properties" = {
